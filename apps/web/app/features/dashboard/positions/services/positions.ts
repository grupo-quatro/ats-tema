...
export const JOBS_DATA: Job[] = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'Design Systems', weight: 4, type: 'mandatory' },
      { name: 'Framer', weight: 2, type: 'desirable' },
      { name: 'Prototyping', weight: 3, type: 'desirable' },
    ],
    salaryMin: 2000,
    salaryMax: 3500,
    currency: 'USD',
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'Machine Learning', weight: 2, type: 'desirable' },
    ],
    salaryMin: 3000,
    salaryMax: 5000,
    currency: 'USD',
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'JavaScript', weight: 4, type: 'mandatory' },
      { name: 'Selenium', weight: 4, type: 'mandatory' },
      { name: 'Playwright', weight: 4, type: 'desirable' },
